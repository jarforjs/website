~function () {
    ...
    AutoBanner.prototype={
        ...
        bindData:function () {
            ...
            if (this.jsonData) {
                for (var i = 0, len = this.jsonData.length; i < len; i++) {
                    ...
                    if(curData["color"]&&curData["color"].length){
                        this.color.push(curData["color"]);
                    }
        ...
        autoMove:function () {
            ...
            this.banner.style.backgroundColor=this.color[this.step];
            this.setBanner();
        },
        //切换效果和焦点对齐
        setBanner:function () {
        ...
        tipEvent:function () {
            ...
            for (var i = 0, len = this.oLis.length; i < len; i++) {
                ...
                curLi.onclick = function () {
                    ...
                    _this.banner.style.backgroundColor=_this.color[_this.step];
                    _this.setBanner();
                }
            }
        },
